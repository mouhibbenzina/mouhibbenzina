...
- 🎓 Computer Science student — heading into my **PFE (Final Year Project)** next year
- 🌱 Currently deepening my skills in **system design**, **AI integration**, and **cloud deployment**
...
|--------|-------------|-------|
| [🔍 CodeReview](https://github.com/mouhibbenzina/codereview-backend) | Full-stack code review platform | Node.js · React · MongoDB |
| [📖 Islam Guide](https://github.com/mouhibbenzina/islam-guide) | Islamic reference web app | Python · React |
| [🧠 ZribaIQ](https://github.com/mouhibbenzina/ZribaIQ) | AI-powered application | TypeScript · Node.js |
